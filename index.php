...
<!--     <div class="spinner-wrapper">
    ...
    <?php if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] !== true) : ?>
        ...
        <div class="mfp-wrap mfp-close-btn-in mfp-auto-cursor my-mfp-slide-bottom mfp-ready" tabindex="-1" style="top: 0px; position: absolute; height: 150px;">
                                    ...
                                    <div class="form-container">
                                        <form data-toggle="validator" data-focus="false" method="POST" action="db/login.php">
                                            <div class="form-group">
                                                ...
                                                <label class="label-control" for="name">Masukan Nama yang Terdaftar (Nama Lengkap)</label>
