                    ...
                    <div class="form-container">
                        <form data-toggle="validator" data-focus="false" method="POST" action="db/insert_user.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="user_nama_panggilan" id="user_nama_panggilan" placeholder="Masukan Nama Panggilan" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">    
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="user_team" placeholder="Masukan No Team" id="user_team" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">    
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="user_jabatan" placeholder="Masukan Jabatan" id="user_jabatan" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <label for="user_unit_kerja">Unit Kerja</label>
                                <input type="text" class="form-control" name="user_unit_kerja" placeholder="Masukan Unit Kerja" id="user_unit_kerja" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            <hr style="min-width: 100%;">
                            ...
                            <div class="form-group">    
                                ...
                                <select class="form-control" name="user_jenis_kendaraan" id="user_jenis_kendaraan" required>
                            ...
                            <div class="form-group">    
                                ...
                                <select class="form-control" name="user_nama_kendaraan" id="user_nama_kendaraan" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="user_nama_villa" id="user_nama_villa" placeholder="Masukan Nama Villa" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <label for="user_kapasitas">Kapasitas Kamar</label>
                                <input type="number" class="form-control" name="user_kapasitas" id="user_kapasitas" placeholder="Masukan Kapasitas Kamar" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">    
                                <label for="user_tipe_bed">Tipe Kasur</label>
                                <select class="form-control" name="user_tipe_bed" id="user_tipe_bed" required>
